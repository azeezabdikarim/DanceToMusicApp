...
def train_one_epoch(pose_model, discriminator, encodec_model, train_loader, criterion_g, optimizer_g, optimizer_d, device, tensorboard_writer, epoch, args):
    """
...
def train():
    ...
    encodec_model, pose_model, discriminator, train_dataset = initialize_model_and_data(args, device)
    ...
    for epoch in range(num_epochs):
        ...
        pose_model, discriminator, encodec_model, loss = train_one_epoch(pose_model, discriminator, encodec_model, train_loader, criterion_g, optimizer_g, optimizer_d, device, writer, epoch, args)
